...
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5665288359").split())
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/mantoo456")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP","https://t.me/Educationbabaoffical2")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/ASIFXQUEEN/NEWQUEENTAGMUSIC")
...
if not MUSIC_BOT_NAME.isascii():
    print(
        "[MADARCHOD] - ASIF KA REPO COPY KARKE UTPATANG HARKAT KAREGA MADARCHOD"
    )
